...
const BookingsTable = ({ isPast }) => {
  ...
  /** Set listingData to be a list with the information about all of the bookings of your listings */
  React.useEffect(() => {
    const getRows = async () => {
      const json = await apiRequest('user/bookings', undefined, 'GET').catch((error) => {
        console.log(error);
